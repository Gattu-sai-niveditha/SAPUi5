		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "project",
									"targetURL": "#uiMyPersonalProjectpersonalproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uiMyPersonalProjectpersonalproject-display": {
								"semanticObject": "uiMyPersonalProjectpersonalproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui.MyPersonalProject.personalproject",
									"url": sap.ui.require.toUrl("ui/MyPersonalProject/personalproject")
								}
							}
						}
					}
